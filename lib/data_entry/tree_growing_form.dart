...
class _TreeGrowingFormState extends State<TreeGrowingForm> {
    ...
    try {
      ...
      if (activityId != null && capturedCoordinates.isNotEmpty) {
        for (final coord in capturedCoordinates) {
          ...
          final photourlAreaSeqId = (createdArea['seq_id'] as num?)?.toInt();

          if (photourlAreaId != null && photourlAreaSeqId != null) {
            if (photoPath != null && photoPath.isNotEmpty) {
              final photoName = _buildTreeGrowingPhotoName(
                divisionTypeId: divisionTypeId,
                activityId: activityId,
                photoId: photourlAreaSeqId,
                sourcePath: photoPath,
              );
          ...
          coord['photourlAreaId'] = photourlAreaId;
          coord['photourlAreaSeqId'] = photourlAreaSeqId?.toString();
        }
      }
  ...
  Future<void> _loadInitialCoordinates() async {
    ...
    try {
      ...
      final loadedCoordinates = areas.map((row) {
