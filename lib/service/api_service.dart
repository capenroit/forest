...
class ApiService {
  ...
  /// Save Monitoring of Tree Survival records — one row per species, each
  /// linked to its source seedling via seed_id == tree_growing_data.id.
  ///
  /// seq_id is not sent; it should be auto-generated by the database identity.
  static Future<void> saveTreeSurvivalMonitoringRows({
    required String userId,
    required int activityId,
    required List<({int seedId, int numberTreeSurvived})> speciesSurvival,
    int? quarter,
    String? details,
